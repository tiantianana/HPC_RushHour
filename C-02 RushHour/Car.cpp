...
/*
 *  Check if the car has reached the goal destination by comparing the current
 *  coordinates (x,y) of the car with the coordinates of the goal state
 *  Inputs:
 *      - cond : goal state condition (0 left, 1 top, 2 right, 3 bottom)
 *      - szx, szy : coordinate of the car
 *  Output:
 *      - boolean : true if the car has reached its goal
 */
